...
<script>
  ...
  let hasScrolledToBottom = (process.env.MODE == 'development') ? true : false
...
<style>
  .to-read::-webkit-scrollbar {
    width: 1px;
  }
  .to-read::-webkit-scrollbar-track {
    background: #f1f1f1;
  }
  .to-read::-webkit-scrollbar-thumb {
    background: #000;
  }
</style>